...
// ── DADOS ───────────────────────────────────────────────────────────────────
const cidades = require('./data/cidades-mg.json');
...
const TIPOS = [
  ...
  },
  {
    ...
    titleFn:    c => `Proteção Veicular para Uber em ${c.nome} | Ativo no 1° Dia`,
    descFn:     c => `Motorista Uber em ${c.nome}? Proteção veicular completa sem carência, cobrindo uso profissional. Ativo no mesmo dia. Cotação grátis pelo WhatsApp.`,
  ...
  },
  {
    ...
    titleFn:    c => `Proteção Veicular para 99 em ${c.nome} | Hélios`,
    descFn:     c => `Motorista 99 em ${c.nome}? Proteção veicular completa sem carência para uso profissional. Cotação grátis.`,
  ...
  },
  {
    ...
    titleFn:    c => `Proteção Veicular para InDriver em ${c.nome} | Hélios`,
  ...
  },
  {
    ...
    titleFn:    c => `Proteção Veicular para Motorista de Aplicativo em ${c.nome}`,
    descFn:     c => `Motorista de aplicativo em ${c.nome}? Uber, 99 ou InDriver. Proteção veicular completa sem carência para uso profissional. Hélios. Cotação grátis.`,
  ...
  },
  {
    ...
    titleFn:    c => `Proteção Veicular para Moto em ${c.nome} MG | Hélios`,
  ...
  },
  {
    ...
    titleFn:    c => `Assistência 24 Horas em ${c.nome} MG | Guincho e Socorro | Hélios`,
    descFn:     c => `Assistência 24 horas em ${c.nome}: guincho, chaveiro, pane seca, troca de pneu e socorro mecânico. Incluída na proteção veicular Hélios sem custo adicional.`,
  ...
  },
  {
    ...
    titleFn:    c => `Guincho 24 Horas em ${c.nome} MG | Hélios Proteção Veicular`,
    descFn:     c => `Guincho 24 horas em ${c.nome}. Solicite agora via WhatsApp. Incluso na proteção veicular Hélios. Atendimento rápido em toda a ${c.regiao}.`,
  ...
  },
  {
    ...
    titleFn:    c => `Reboque 24 Horas em ${c.nome} MG | Hélios Proteção Veicular`,
    descFn:     c => `Reboque 24 horas em ${c.nome}. Atendimento imediato. Incluso na proteção veicular Hélios. Solicite pelo WhatsApp agora.`,
  ...
  // 11. DELIVERY (self-canonical)
  {
    ...
    titleFn:    c => `Proteção Veicular para Delivery em ${c.nome} | iFood, Rappi, Loggi | Hélios`,
    descFn:     c => `Motorista de delivery em ${c.nome}? iFood, Rappi, Loggi e outros. Proteção veicular completa sem carência para uso profissional. Ativo no 1° dia. Cotação grátis.`,
  ...
  // 13. MOTOBOY (self-canonical)
  {
    ...
    titleFn:    c => `Proteção Veicular para Motoboy em ${c.nome} | Hélios`,
    descFn:     c => `Motoboy em ${c.nome}? Proteção veicular para moto sem carência, com cobertura para uso profissional em delivery e entregas. Cotação grátis.`,
  ...
  // 15. VAN (self-canonical)
  {
    ...
    titleFn:    c => `Proteção Veicular para Van em ${c.nome} | Hélios`,
    descFn:     c => `Proteção veicular para van e minivan em ${c.nome}. Cobertura completa contra roubo, furto e colisão. Sem carência. Hélios protege sua van. Cotação grátis.`,
  ...
  // 16. FROTA (self-canonical)
  {
    ...
    titleFn:    c => `Proteção Veicular para Frota em ${c.nome} | Hélios Empresas`,
    descFn:     c => `Proteção veicular para frota empresarial em ${c.nome}. Proteja vários veículos da sua empresa com condições especiais. Sem carência. Cotação grátis.`,
  ...
  // 17. PCD (self-canonical)
  {
    ...
    titleFn:    c => `Proteção Veicular para PCD em ${c.nome} | Hélios`,
    descFn:     c => `Proteção veicular para PCD em ${c.nome}. Pessoa com deficiência também pode proteger seu veículo sem carência. Aceitamos veículos adaptados. Cotação grátis.`,
  ...
  // 19. JOVEM (self-canonical)
  {
    ...
    titleFn:    c => `Proteção Veicular para Jovem em ${c.nome} | Sem Restrição de Idade`,
    descFn:     c => `Proteção veicular para jovem em ${c.nome}. Sem restrição de idade, sem carência. A Hélios aceita condutores jovens. Mais barato que o seguro tradicional. Cotação grátis.`,
  ...
  // 20. FINANCIADO (self-canonical)
  {
    ...
    titleFn:    c => `Proteção Veicular para Carro Financiado em ${c.nome} | Hélios`,
    descFn:     c => `Proteção veicular para carro financiado ou alienado em ${c.nome}. Aceita veículo com alienação fiduciária. Sem carência. Hélios protege seu financiado. Cotação grátis.`,
  ...
  // 21. SEM CARÊNCIA (self-canonical)
  {
    ...
    titleFn:    c => `Proteção Veicular sem Carência em ${c.nome} | Ativa no 1° Dia | Hélios`,
    descFn:     c => `Proteção veicular sem carência em ${c.nome}. Ativa no 1° dia. Sem período de espera. Cobertura completa desde o primeiro momento. Hélios. Cotação grátis.`,
  ...
  // 23. CARRO RESERVA (self-canonical)
  {
    ...
    titleFn:    c => `Carro Reserva em ${c.nome} | Incluído na Proteção Hélios`,
    descFn:     c => `Carro reserva em ${c.nome} incluído na proteção veicular Hélios. Em caso de sinistro, você não fica sem transporte. Assistência 24h. Cotação grátis.`,
  ...
  // 24. PROTEÇÃO DE VIDROS (self-canonical)
  {
    ...
    titleFn:    c => `Proteção de Vidros em ${c.nome} | Para-brisa Incluso | Hélios`,
    descFn:     c => `Proteção de vidros em ${c.nome}. Troca de para-brisa, vidros laterais e traseiro incluídos na proteção veicular Hélios. Sem carência. Cotação grátis.`,
  ...
  // 25. SOCORRO MECÂNICO (self-canonical)
  {
    ...
    titleFn:    c => `Socorro Mecânico 24h em ${c.nome} | Hélios Proteção Veicular`,
    descFn:     c => `Socorro mecânico 24 horas em ${c.nome}. Pane seca, bateria, troca de pneu e chaveiro incluídos na proteção Hélios. Atendimento imediato. Cotação grátis.`,
  ...
  // 26–29. ALIASES DELIVERY
  {
    ...
    titleFn:    c => `Proteção Veicular para iFood em ${c.nome} | Hélios`,
  ...
  },
  {
    ...
    titleFn:    c => `Proteção Veicular para Rappi em ${c.nome} | Hélios`,
  ...
  },
  {
    ...
    titleFn:    c => `Proteção Veicular para Shopper em ${c.nome} | Hélios`,
  ...
  },
  {
    ...
    titleFn:    c => `Proteção Veicular para Loggi em ${c.nome} | Hélios`,
  ...
  // 30–31. ALIASES CAMINHONETE
  {
    ...
    titleFn:    c => `Proteção Veicular para SUV em ${c.nome} | Hélios`,
  ...
  },
  {
    ...
    titleFn:    c => `Proteção Veicular para Picape em ${c.nome} | Hélios`,
  ...
  },
  {
    ...
    titleFn:    c => `Chaveiro 24h em ${c.nome} | Incluso na Proteção Hélios`,
    descFn:     c => `Chaveiro 24 horas em ${c.nome}. Incluso na proteção veicular Hélios. Atendimento imediato em caso de chave quebrada ou esquecida no carro. Cotação grátis.`,
  ...
  // 34–35. ALIAS RASTREAMENTO + COTAÇÃO
  {
    ...
    titleFn:    c => `Rastreamento Veicular em ${c.nome} | Incluso na Proteção Hélios`,
  ...
  },
  {
    ...
    titleFn:    c => `Cotação Proteção Veicular em ${c.nome} | Grátis e Rápido | Hélios`,
    descFn:     c => `Faça sua cotação de proteção veicular em ${c.nome}. Grátis, rápido e sem compromisso. A Hélios responde em minutos pelo WhatsApp. Cotação grátis agora.`,
