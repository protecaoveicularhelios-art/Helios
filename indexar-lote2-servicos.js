...
// Self-canonical types (cidade já indexada antes — apenas os novos)
const TIPOS_NOVOS = [
...
const URLS = lote2.flatMap(c => TIPOS_NOVOS.map(fn => fn(c)));
...
async function main() {
  console.log(`📋 Total de URLs a indexar: ${URLS.length} (4 tipos × 46 cidades)`);
